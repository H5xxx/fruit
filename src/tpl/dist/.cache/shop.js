/*TMODJS:{"version":42,"md5":"90ae19151ab3c0e91e9f798a4292c565"}*/
...
$out+=' </ul> </div> <div class="main-cnt"> <div class="j-package-list-wrapper"> </div> <div class="j-fruit-list-wrapper"> </div> </div> <div class="j-bar bar"> <p class="cnt">已选购 <span class="j-num num">3</span> 件，共 <span class="j-sum sum">15</span> 元</p> <i class="j-next op icon icon-tick"></i> </div>';
