/*TMODJS:{"version":2,"md5":"90f1b0ac1f70b57f98f1718fe7de338a"}*/
...
$out+=' </ul> </div> <div class="main-cnt"> <div class="j-package-list-wrapper sub-opts-wrapper"> </div> <div class="j-fruit-list-wrapper"> </div> </div> <div class="j-bar bar"> <p class="cnt">已选购 <span class="j-num num">3</span> 件，共 <span class="j-sum sum">15</span> 元</p> <i class="j-next op icon">去结算</i> </div>';
