/*TMODJS:{"version":6,"md5":"460101442f3308326c911b767ffa3161"}*/
template('popup-fruit',function($data,$filename) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,image=$data.image,name=$data.name,price=$data.price,discrbe=$data.discrbe,weight=$data.weight,$out='';$out+='<div class="popup-wrapper popup-fruit"> <div class="j-popup-close close">X</div> <div class="fruit-detail-wrapper"> <div class="fruit-img"> <img src="';
$out+=$escape(image);
$out+='" width="100%" height="100%"> </div> <div class="fruit-info-block"> <span class="j-fav fav">+收藏</span> <h5 class="fruit-name">';
$out+=$escape(name);
